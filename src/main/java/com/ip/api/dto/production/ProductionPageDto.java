...
@AllArgsConstructor
@NoArgsConstructor
public class ProductionPageDto<T> {
    ...
    public static <T> ProductionPageDto<T> from(Page<T> page, String sortBy, String sortDirection) {
        return ProductionPageDto.<T>builder()
